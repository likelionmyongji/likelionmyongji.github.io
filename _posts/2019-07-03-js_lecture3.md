...
<strong>산술 연산자</strong>는 사칙연산과 같은 작업을 하는 연산자입니다.
...
<strong>대입 연산자</strong>는 변수에 연산한 값을 바로 할당할 때 사용되는 연산자입니다.
...
<strong>논라 연산자</strong>는 Boolean Type을 위한 연산자입니다. 
...
<strong>비교 연산자</strong>는 두 값을 비교할 때 사용합니다. 값이 같으면 true, 아니면 false를 반환합니다.
...
코드에 메모를 달고 싶을 때에는 아래와 같이 작성할 수 있습니다. 이를 <strong>주석</strong>이라고 합니다.
